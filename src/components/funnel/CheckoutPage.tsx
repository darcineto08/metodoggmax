        ...
        <div className="container max-w-md mx-auto space-y-6">
          ...
          <div className="space-y-4">
            ...
            <motion.div
              ...
              className={`bg-card rounded-2xl p-5 cursor-pointer transition-all border-2 ${
                selectedPlan === "basic"
            ...
            <motion.div
              ...
              className={`relative bg-card rounded-2xl p-5 cursor-pointer transition-all border-2 ${
